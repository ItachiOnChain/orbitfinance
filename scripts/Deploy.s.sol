...
contract DeployOrbitFinance is Script {
    function run() external {
        ...
        console.log("=== ORBIT FINANCE DEPLOYMENT ===");
        ...
        // 9. Seed Test Account
        console.log("9. Seeding Test Account...");
        address testAccount = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; // Anvil default
        weth.mint(testAccount, 10 ether);
        usdc.mint(testAccount, 50000e6);
        console.log("  Test Account:", testAccount);
        console.log("  WETH Balance: 10");
        console.log("  USDC Balance: 50,000");
        console.log("");
        ...
        console.log("");
        console.log("Copy these addresses to src/contracts/addresses.ts:");
        console.log("");
        console.log("export const CONTRACTS = {");
        console.log("  anvil: {");
        console.log("    AccountFactory: '%s',", address(factory));
        console.log("    DebtManager: '%s',", address(debtManager));
        console.log("    VaultRegistry: '%s',", address(registry));
        console.log("    PriceOracle: '%s',", address(oracle));
        console.log("    orUSD: '%s',", address(debtToken));
        console.log("    WETH: '%s',", address(weth));
        console.log("    USDC: '%s',", address(usdc));
        console.log("    WETH_Vault: '%s',", address(wethVault));
        console.log("    USDC_Vault: '%s',", address(usdcVault));
        console.log("    WETH_Strategy: '%s',", address(wethStrategy));
        console.log("    USDC_Strategy: '%s',", address(usdcStrategy));
        console.log("  }");
        console.log("};");
    }
}
