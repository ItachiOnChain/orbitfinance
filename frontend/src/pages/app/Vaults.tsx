        ...
        <div className="space-y-8 max-w-6xl mx-auto">
            ...
            <div className="flex gap-4 bg-zinc-900/50 p-2 rounded-lg border border-zinc-800/50 w-fit">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-light transition-all ${
                        activeTab === 'all'
            ...
            <div className="grid grid-cols-4 gap-8 bg-zinc-900/30 p-6 rounded-xl border border-zinc-800/50 hover:border-gold/20 transition-colors duration-500">
                <div>
                    ...
                    <p className="text-2xl font-light text-gold drop-shadow-[0_0_5px_rgba(251,191,36,0.3)]">$0.00</p>
                </div>
                <div>
                ...
                <div>
                    <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Available Credit</p>
                    <p className="text-2xl font-light text-gold drop-shadow-[0_0_5px_rgba(251,191,36,0.3)]">$0.00</p>
                </div>
